...
class _SettingPageState extends State<SettingPage> {
  ...
  List blacklistedHomeSections = Hive.box('settings').get('blacklistedHomeSections', defaultValue: []) as List;
  String streamingQuality = Hive.box('settings').get('streamingQuality', defaultValue: '96 kbps') as String;
  String ytQuality = Hive.box('settings').get('ytQuality', defaultValue: 'Low') as String;
  String downloadQuality = Hive.box('settings').get('downloadQuality', defaultValue: '320 kbps') as String;
  String ytDownloadQuality = Hive.box('settings').get('ytDownloadQuality', defaultValue: 'High') as String;
  ...
  int downFilename = Hive.box('settings').get('downFilename', defaultValue: 0) as int;
                                            ...
                                            for (int hue in [100, 200, 400, 700])
                                              GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: (themeColor == colors[index] && colorHue == hue)
                                                      ? const Icon(
                                                          Icons.done_rounded,
                                                        )
                                                      : const SizedBox(),
                                          ...
                                          return Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                child: (currentTheme.getBackGradient() == gradients[index])
                                                    ? const Icon(
                                                        Icons.done_rounded,
                                                      )
                                                    : const SizedBox(),
                                          ...
                                          return Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                child: (currentTheme.getCardGradient() == gradients[index])
                                                    ? const Icon(
                                                        Icons.done_rounded,
                                                      )
                                                    : const SizedBox(),
                                          ...
                                          return Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                child: (currentTheme.getBottomGradient() == gradients[index])
                                                    ? const Icon(
                                                        Icons.done_rounded,
                                                      )
                                                    : const SizedBox(),
                              ...
                              if (themeChoice != null) {
                                ...
                                setState(
                                  () {
                                    ...
                                    currentTheme.backGrad = themeChoice == deflt ? 2 : selectedTheme['backGrad'] as int;

                                    settingsBox.put(
                                      'cardGrad',
                                      themeChoice == deflt ? 4 : selectedTheme['cardGrad'],
                                    );
                                    currentTheme.cardGrad = themeChoice == deflt ? 4 : selectedTheme['cardGrad'] as int;

                                    settingsBox.put(
                                      'bottomGrad',
                                      themeChoice == deflt ? 3 : selectedTheme['bottomGrad'],
                                    );
                                    currentTheme.bottomGrad = themeChoice == deflt ? 3 : selectedTheme['bottomGrad'] as int;

                                    currentTheme.switchCanvasColor(
                                      themeChoice == deflt ? 'Grey' : selectedTheme['canvasColor'] as String,
                                      notify: false,
                                    );
                                    canvasColor = themeChoice == deflt ? 'Grey' : selectedTheme['canvasColor'] as String;

                                    currentTheme.switchCardColor(
                                      themeChoice == deflt ? 'Grey900' : selectedTheme['cardColor'] as String,
                                      notify: false,
                                    );
                                    cardColor = themeChoice == deflt ? 'Grey900' : selectedTheme['cardColor'] as String;

                                    themeColor = themeChoice == deflt ? 'Teal' : selectedTheme['accentColor'] as String;
                                    colorHue = themeChoice == deflt ? 400 : selectedTheme['colorHue'] as int;
                                    ...
                                    currentTheme.switchTheme(
                                      useSystemTheme: !(themeChoice == deflt) && selectedTheme['useSystemTheme'] as bool,
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                opaque: false,
                                pageBuilder: (_, __, ___) => const PlayerGradientSelection(),
                              ),
                            );
                          },
                        ),
                                  ...
                                  builder: (
                                    ...
                                    return AlertDialog(
                                        ...
                                        child: ReorderableListView(
                                          ...
                                          children: order.map((e) {
                                            return CheckboxListTile(
                                              ...
                                              checkColor: Theme.of(context).colorScheme.secondary == Colors.white ? Colors.black : null,
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          style: TextButton.styleFrom(
                                            foregroundColor: Theme.of(context).colorScheme.secondary == Colors.white ? Colors.black : null,
                                            backgroundColor: Theme.of(context).colorScheme.secondary,
                                          ),
                                          onPressed: () {
                                            setState(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: DropdownButton(
                            ...
                            items: <String>['Low', 'High'].map<DropdownMenuItem<String>>((String value) {
                              return DropdownMenuItem<String>(
                                value: value,
                                child: Text(value),
                              );
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: DropdownButton(
                                ...
                                setState(
                                  () {
                                    ...
                                    MyApp.of(context).setLocale(
                                      Locale.fromSubtags(
                                        languageCode: ConstantCodes.languageCodes[newValue] ?? 'en',
                                      ),
                                    );
                            ...
                            items: ConstantCodes.languageCodes.keys.map<DropdownMenuItem<String>>((language) {
                              return DropdownMenuItem<String>(
                                value: language,
                                child: Text(
                                  language,
                                                  ...
                                                  children: <Widget>[
                                                    ChoiceChip(
                                                      ...
                                                      labelStyle: TextStyle(
                                                        color: !value ? Theme.of(context).colorScheme.secondary : Theme.of(context).textTheme.bodyText1!.color,
                                      ...
                                      if (idx == 1) {
                                        return ListTile(
                                          ...
                                          onTap: () async {
                                            ...
                                            if (temp.trim() != '' && !includedExcludedPaths.contains(temp)) {
                            ...
                            showTextInputDialog(
                              ...
                              title: AppLocalizations.of(
                                context,
                                  ...
                                  .minAudioAlert,
                              initialText: (Hive.box('settings').get('minDuration', defaultValue: 10) as int).toString(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          isThreeLine: true,
                          onTap: () {
                            const String upiUrl = 'upi://pay?pa=ankit.sangwan.5688@oksbi&pn=BlackHole';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
